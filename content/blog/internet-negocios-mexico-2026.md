...
|---|---|---|
| Tolerancia a caídas | Media | Baja |
| Velocidad de subida | Baja aceptable | Alta necesaria |
| Soporte técnico | Estándar | Prioritario |
| Horario de uso | Tardes y noches | Todo el día |
| Respaldo | Opcional | Necesario |
...
|---|---:|---|---|
| Plan residencial de fibra | $400-$1,000 MXN/mes | Barato | Sin SLA, soporte estándar |
| Plan empresarial Telmex | $600-$2,000 MXN/mes | Soporte prioritario | Más caro |
| Plan empresarial Totalplay | $500-$1,500 MXN/mes | Fibra simétrica | Cobertura limitada |
...
2. **Prioriza fibra simétrica** (misma velocidad de subida y bajada).
3. **Verifica si el proveedor ofrece SLA** (tiempo de respuesta garantizado).
4. **Considera un respaldo de 4G fijo** para emergencias.
5. **Pregunta por IP fija** si necesitas acceder a cámaras o sistemas remotamente.
6. **Revisa el plazo forzoso** y la escalabilidad del plan.
...
- **Cobros con tarjeta** (terminal POS).
- **Sistemas en la nube** (facturación, inventario).
- **Videollamadas** con clientes o proveedores.

**Opciones de respaldo:**

| Respado | Costo | Activación | Velocidad |
|---|---:|---|---|
| Hotspot de celular | $0 (ya lo tienes) | Inmediata | 10-50 Mbps |
| 4G fijo dedicado | $200-$400 MXN/mes | Inmediata | 10-40 Mbps |
| Segundo proveedor (fibra) | $400-$1,000 MXN/mes | Inmediata (si hay) | 100+ Mbps |
...
Si tu negocio es pequeño (1-5 personas) y tolera caídas ocasionales, un residencial basta. Si no puedes tolerar caídas, busca un plan empresarial con SLA.

### ¿IP fija sirve para algo en un negocio?

Sí. Te permite acceder a cámaras de seguridad, sistemas POS o servidores desde fuera de tu negocio. Algunos proveedores la incluyen en planes empresariales.

### ¿Qué router necesito para mi negocio?

Un router que maneje bien 20+ dispositivos y tenga QoS. Si tienes POS, cámaras y personal, necesitas más capacidad que en una casa. Lee [cómo elegir router WiFi](/internet-en-casa/como-elegir-router-wifi-mexico.html).
