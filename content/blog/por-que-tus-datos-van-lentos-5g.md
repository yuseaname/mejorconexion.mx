...
-   Los videos se quedan cargando en calidad baja.
-   Las apps tardan en sincronizarse.
...
-   Modo ahorro de batería (puede limitar datos).
-   Preferencia de red (a veces fija 4G aunque tengas 5G).
...
Revisa velocidad de descarga, subida y latencia. Si la latencia es muy alta, la navegación se siente lenta aunque la descarga esté bien.
...
-   Ubicación aproximada y horarios.
-   Resultados de pruebas de velocidad.
-   Modelo de tu teléfono.

Con datos claros, el soporte tiene más oportunidad de ayudarte.
...
2.  Prueba en distintos horarios (mañana, tarde, noche).
3.  Desactiva VPN si usas una.
4.  Revisa si el plan tiene política de uso justo.
5.  Compara con otro celular en la misma zona.
...
Si en tu zona el 5G está saturado, a veces forzar 4G da más estabilidad.

### Revisa la cobertura real

Si tu zona no tiene 5G sólido, el rendimiento será parecido a 4G.

### Evita ahorro extremo de batería

Algunos modos limitan velocidad para ahorrar energía.

### Considera un equipo más reciente

Si tu celular no soporta bandas clave, la experiencia será limitada.

### Reinicia la conexión móvil

Activar y desactivar modo avión durante 10 segundos puede forzar una mejor conexión.
...
Eso apunta a interferencia por paredes. La solución práctica es usar Wi‑Fi en casa.

### "Solo va lento por las noches"

Es congestión. No es tu equipo, es el uso masivo en tu zona.

### "Mi amigo con otro celular va más rápido"

Tu equipo quizá no soporta las mismas bandas. En ese caso, cambiar equipo puede mejorar más que cambiar plan.
...
No. Depende de congestión y cobertura real.

### "Cambiar de operador siempre arregla"

Puede ayudar, pero primero revisa si el problema es tu zona o tu equipo.

### "El 5G gasta más datos"

El consumo depende del uso, no de la red.
...
-   Comparar horarios pico y valle.
-   Revisar plan y uso justo.
-   Desactivar VPN si aplica.
-   Confirmar compatibilidad del equipo.

Con esto detectas la causa principal en minutos.
...
-   Las páginas cargan rápido sin quedarse en blanco.
-   El video sube de calidad sin pausas largas.
-   Las apps sincronizan en segundos, no en minutos.
-   Los tests muestran latencia más estable.

Si no ves mejoras después de estos pasos, considera reportar al operador o evaluar otro equipo.
...
En teoría sí, pero en la práctica depende de la congestión y la cobertura.

### ¿Mi plan afecta la velocidad?

Sí. Algunos planes bajan velocidad después de cierto consumo.

### ¿Por qué en la noche va más lento?

Es horario pico. Más personas usan la misma antena.
