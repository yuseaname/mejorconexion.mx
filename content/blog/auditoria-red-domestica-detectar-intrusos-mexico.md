...
Una red limpia y sin intrusos rinde mejor, pero si ya aseguraste tu router y la velocidad sigue corta, conviene revisar si tu plan y proveedor son los adecuados para tu hogar en nuestro [ranking de proveedores 2026](/blog/cual-es-el-mejor-internet-en-mexico-2026.html).
...
-   El Wi‑Fi se pone lento sin explicación.
-   El router se reinicia o se calienta más de lo normal.
-   Aparecen dispositivos con nombres que no reconoces.
-   La contraseña se compartió muchas veces.
...
-   Acceso al router (usuario y contraseña).
-   Lista básica de tus dispositivos (celulares, laptops, TV, consola).
-   15 minutos sin prisas.

Si no sabes la clave del router, revisa la etiqueta o pregunta al proveedor. Luego cámbiala por una segura.

También es buen momento para actualizar la app del router si usas una, así evitas errores de acceso.
...
3.  Bloquea o elimina cualquier dispositivo desconocido.
4.  Cambia la contraseña del Wi‑Fi si hay dudas.
5.  Verifica si hay actualización de firmware.
...
Un tip práctico es renombrar tus dispositivos dentro del router. Así es más fácil detectar "intrusos" en el futuro.
...
Si tu router permite etiquetas, úsalo. Cambiar "Unknown-4F" por "TV sala" hace que las auditorías siguientes sean mucho más rápidas.
...
-   **Desactivar WPS:** es una puerta fácil de explotar.
-   **Usar WPA3 o WPA2:** evita modos antiguos.
-   **Cambiar usuario admin:** no dejes el de fábrica.
...
1.  Cambia la contraseña del Wi‑Fi.
2.  Cambia la contraseña del administrador del router.
3.  Desactiva WPS.
4.  Bloquea el dispositivo sospechoso.
...
1.  Restablece el router a valores seguros si no confías en su configuración.
2.  Configura nuevamente la red con WPA2/WPA3 y clave nueva.
3.  Recrea la red de invitados para IoT y visitas.
...
También haz una auditoría cuando:
...
Haz pruebas rápidas en la mañana, tarde y noche. Si el rendimiento cae solo de noche, puede ser saturación del proveedor o de la zona.

Si la caída ocurre a cualquier hora, revisa tu red local y la lista de dispositivos.
...
Solución: cambias la contraseña del Wi‑Fi, apagas WPS y bloqueas ese dispositivo. Luego creas una red de invitados para visitas. En la siguiente semana, el Wi‑Fi vuelve a ser estable.

Este tipo de auditoría evita que el problema se repita cada mes.
...
-   Olvidar cambiar la clave del administrador del router.
-   Dejar IoT en la misma red de trabajo.
...
-   Apps oficiales del router para ver dispositivos en tiempo real.
-   Escáneres básicos de red para detectar nuevos equipos.
...
Lo ideal es usar una red de invitados con contraseña distinta. Así puedes cambiar esa clave sin afectar a tu red principal.
...
**Firmware:** sistema interno del router. Actualizarlo corrige fallas.
...
-   Revisar reglas de puertos y UPnP.
-   Confirmar que DNS seguro siga activo.
-   Separar IoT en red de invitados.
...
-   Reinicia el router solo si hiciste cambios grandes.
-   Conecta un par de dispositivos para confirmar estabilidad.
-   Apunta la fecha de la próxima revisión.
...
-   Contraseña nueva si hay dudas.
-   WPS apagado.
-   Firmware actualizado.
-   IoT separado en red de invitados.
-   DNS seguro activo.

Con este checklist, tu red se mantiene protegida sin drama.

Si algo falla, vuelve al paso básico: cambiar contraseña y revisar dispositivos.
...
Una vez al mes suele ser suficiente en hogares normales.

### ¿Necesito apps especiales?

No. El panel del router y la app oficial suelen ser suficientes.

### ¿Es normal ver dispositivos desconocidos?

No debería pasar. Si no reconoces algo, bórralo y cambia clave.
