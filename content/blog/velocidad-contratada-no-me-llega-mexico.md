...
2. Cierra todas las descargas y streaming.
3. Haz un test de velocidad.
4. Si recibes el 80%+ de tu plan por cable, el proveedor está cumpliendo.
...
| Situación | Velocidad típica |
|---|---:|
| Por cable Ethernet | 90-100% del plan |
| WiFi 5 GHz cerca del router | 60-80% |
| WiFi 2.4 GHz cerca | 30-50% |
...
2. **Llama a soporte** con los datos (fechas, horas, velocidades).
3. **Pide folio de reporte.**
...
Recibir el 80% o más es normal (por pérdidas técnicas). Recibir el 50% o menos constantemente no es normal y puedes reclamar.

### ¿El proveedor me puede bajar la velocidad sin avisar?

No deliberadamente. Pero la congestión de la red puede hacer que la velocidad efectiva baje en horario pico.

### ¿Puedo cancelar sin pena si no me dan la velocidad?

Depende del contrato. Algunos contratos permiten cancelación si el servicio no cumple. Documenta todo antes de intentar.
