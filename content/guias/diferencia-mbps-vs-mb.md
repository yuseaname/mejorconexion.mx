...
- **Byte:** un grupo de 8 bits. Un caracter de texto (como la letra "A") ocupa aproximadamente un byte.
...
1. Convierte: 100 Mbps ÷ 8 = 12.5 MB/s
2. Convierte el juego: 50 GB = 50,000 MB
3. Divide: 50,000 MB ÷ 12.5 MB/s = 4,000 segundos
...
|---|---|---:|
| Kilobit por segundo | Kbps | 1,000 bits/seg |
| Megabit por segundo | Mbps | 1,000 Kbps |
| Gigabit por segundo | Gbps | 1,000 Mbps |
| Megabyte por segundo | MB/s | 8 Mbps |
...
Si pagas 200 Mbps y tu descarga marca 25 MB/s, recibes exactamente lo que contrataste. Son unidades distintas.

### Confundir almacenamiento con velocidad

Un celular de "128 GB" tiene almacenamiento (gigabytes). Un plan de "200 Mbps" tiene velocidad (megabits por segundo). No se comparan directamente.
...
Porque el número se ve más grande. 100 Mbps suena más impresionante que 12.5 MB/s. Es una práctica estándar en todo el mundo, no exclusiva de México.

### ¿Cómo sé si recibo la velocidad que pago?

Mide por cable Ethernet, con todo cerrado. Si el resultado se acerca al 80% o más de tu plan, está bien. Lee [cómo medir la velocidad real](/guias/como-medir-velocidad-real-internet.html).

### ¿1 Gbps es lo mismo que 1000 Mbps?

Sí. Gbps significa gigabits por segundo. 1 Gbps = 1000 Mbps.
